...
1 - * Faça o download do aplicativo https://github.com/caio-ribeiro-pereira/CollectionsBenchmark/raw/master/dist/collection-benchmark-1.0.jar
...
3 - Execute o comando java jar collection-benchmark-1.0.jar
